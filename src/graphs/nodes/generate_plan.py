...
### 标题页
image_prompt 格式："场景描述，小丸子站立在中下区域，头顶留白 25%"

### 跟读句（scene 包含"第X句"）
image_prompt 格式："与句子意思匹配的场景描述，小丸子站立在中下区域或画面中间偏下，头顶留白 25%"
示例："小丸子站在酒店前台微笑着递出证件，小丸子站立在中下区域，头顶留白 25%"

### 结尾复习页（scene 包含"复习"）
image_prompt 格式："干净的复习卡背景，小丸子缩小放置在画面左下角或右下角，人物占画面高度不超过 30%，右侧和上方留出至少 60% 空间给字幕"
示例："干净简洁的复习卡背景，小丸子缩小放置在左下角，右侧留白区域占画面 60% 以上"
